...
FIELD_TYPE_MAPPING = {
    ...
    "DateField": lambda: fake.date(),
    "DateTimeField": lambda: fake.date_time(),
    "TimeField": lambda: fake.time(),
    ...
    "FileField": lambda: fake.file_name(category="document"),
    ...
    "DurationField": lambda: timedelta(seconds=random.randint(60, 3600)),
